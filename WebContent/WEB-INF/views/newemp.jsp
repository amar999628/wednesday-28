...
<body>
    ...
    <form:form action="addprojecttask" method="POST" modelAttribute="projectTaskInput">
        ...
        <label for="taskCreationDateTime">Task Creation Date:</label>
        <input type="date" id="taskCreationDateTime" name="taskCreationDateTime" required/><br/>

        <label for="taskExpectedDateTime">Task Expected Date:</label>
        <input type="date" id="taskExpectedDateTime" name="taskExpectedDateTime" required/><br/>
