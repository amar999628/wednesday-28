...
public class ResourceServiceImpl implements ResourceService {
	...
	public void save(UserInput existingResource) {
		...
		existingResource.setUserEmployeeId(existingResource.getUserEmployeeId());
		existingResource.setUserMail(existingResource.getUserMail());
		existingResource.setUserPassword(existingResource.getUserPassword());
